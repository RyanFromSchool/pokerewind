...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_SUBSTEE] = gMonIcon_Substee,
    [SPECIES_MANEMBER] = gMonIcon_Manember,
    [SPECIES_TRECHIBER] = gMonIcon_Trechiber,
    [SPECIES_BULBITE] = gMonIcon_Bulbite,
    [SPECIES_LAMPUPA] = gMonIcon_Lampupa,
    [SPECIES_ELECREEP] = gMonIcon_Elecreep,
    [SPECIES_ACTURUNK] = gMonIcon_Acturunk,
    [SPECIES_DRAMASPIRE] = gMonIcon_Dramaspire,
    [SPECIES_BURROBIT] = gMonIcon_Burrobit,
    [SPECIES_RABBITATE] = gMonIcon_Rabbitate,
    [SPECIES_CUCKOOB] = gMonIcon_Cuckoob,
    [SPECIES_TWIDDIES] = gMonIcon_Twiddies,
    [SPECIES_AIRIOLA] = gMonIcon_Airiola,
    [SPECIES_STANDAAD] = gMonIcon_Standaad,
    [SPECIES_RECKLOAT] = gMonIcon_Reckloat,
    [SPECIES_DEVILOAT] = gMonIcon_Deviloat,
    [SPECIES_KITKAR] = gMonIcon_Kitkar,
    [SPECIES_CANNEKO] = gMonIcon_Canneko,
    [SPECIES_GRUBFEED] = gMonIcon_Grubfeed,
    [SPECIES_KWIZBEE] = gMonIcon_Kwizbee,
    [SPECIES_COSMONARCH] = gMonIcon_Cosmonarch,
    [SPECIES_PAASTEL] = gMonIcon_Paastel,
    [SPECIES_SHEEPASTRY] = gMonIcon_Sheepastry,
    [SPECIES_PIKASH] = gMonIcon_Pikash,
    [SPECIES_SONIKACHU] = gMonIcon_Sonikachu,
    [SPECIES_TYPURR] = gMonIcon_Typurr,
    [SPECIES_CALIKEY] = gMonIcon_Calikey,
    [SPECIES_SPOOKIDS] = gMonIcon_Spookids,
    [SPECIES_TOGETERROR] = gMonIcon_Togeterror,
    [SPECIES_BUBOZOA] = gMonIcon_Bubozoa,
    [SPECIES_CHRYSAPOD] = gMonIcon_Chrysapod,
    [SPECIES_ARGIGAMI] = gMonIcon_Argigami,
    [SPECIES_DISPUTRAW] = gMonIcon_Disputraw,
    [SPECIES_SPIRICK] = gMonIcon_Spirick,
    [SPECIES_PLAGHOST] = gMonIcon_Plaghost,
    [SPECIES_COVILED] = gMonIcon_Coviled,
    [SPECIES_CONTRIP] = gMonIcon_Contrip,
    [SPECIES_PLUNGEMENT] = gMonIcon_Plungement,
    [SPECIES_ACCIDROP] = gMonIcon_Accidrop,
    [SPECIES_CURSWORM] = gMonIcon_Cursworm,
    [SPECIES_WINDOWORM] = gMonIcon_Windoworm,
    [SPECIES_LOCKSMIAN] = gMonIcon_Locksmian,
    [SPECIES_BINYOTAKE] = gMonIcon_Binyotake,
    [SPECIES_SVAMPELETT] = gMonIcon_Svampelett,
    [SPECIES_KRABADICT] = gMonIcon_Krabadict,
    [SPECIES_KETAGENE] = gMonIcon_Ketagene,
	[SPECIES_SHORTS] = gMonIcon_Shorts,
	[SPECIES_PANTS] = gMonIcon_Pants,
	[SPECIES_CACOBELLE] = gMonIcon_Cacobelle,
	[SPECIES_DELPHIER] = gMonIcon_Delphier,
	[SPECIES_ENTESAGT] = gMonIcon_Entesagt,
	[SPECIES_SKELIPEDE] = gMonIcon_Skelipede,
    [SPECIES_COFFINSECT] = gMonIcon_Coffinsect,
    [SPECIES_TERRACAL] = gMonIcon_Terracal,
    [SPECIES_DIGFLOPPA] = gMonIcon_Digfloppa,
	[SPECIES_TELECO] = gMonIcon_Teleco,
	[SPECIES_ESAKIT] = gMonIcon_Esakit,
	[SPECIES_FOREKAYE] = gMonIcon_Forekaye,
	[SPECIES_HELLMO] = gMonIcon_Hellmo,
    [SPECIES_RANDOMAIL] = gMonIcon_Randomail,
    [SPECIES_DEDLIVERY] = gMonIcon_Dedlivery,
    [SPECIES_SIXTEEVY] = gMonIcon_Sixteevy,
    [SPECIES_TENEIDEEPI] = gMonIcon_Teneideepi,
    [SPECIES_MLADIBUG] = gMonIcon_Mladibug,
    [SPECIES_FLEXNAKE] = gMonIcon_Flexnake,
    [SPECIES_FLEXAIL] = gMonIcon_Flexail,
    [SPECIES_ETIKUB] = gMonIcon_Etikub,
    [SPECIES_DESMANTHER] = gMonIcon_Desmanther,
    [SPECIES_SUPPORPOD] = gMonIcon_Supporpod,
    [SPECIES_FLYPOD] = gMonIcon_Flypod,
    [SPECIES_VEESEE] = gMonIcon_Veesee,
    [SPECIES_DRACORD] = gMonIcon_Dracord,
    [SPECIES_DONKRIME] = gMonIcon_Donkrime,
    [SPECIES_MAFIADASS] = gMonIcon_Mafiadass,
    [SPECIES_MLGLOB] = gMonIcon_Mlglob,
    [SPECIES_BRAIMATE] = gMonIcon_Braimate,
    [SPECIES_CREWEBRAL] = gMonIcon_Crewebral,
    [SPECIES_IMPVADER] = gMonIcon_Impvader,
    [SPECIES_EXTERESSUS] = gMonIcon_Exteressus,
    [SPECIES_ALSNOW] = gMonIcon_Alsnow,
    [SPECIES_COOLLEM] = gMonIcon_Coollem,
    [SPECIES_DARKORPSE] = gMonIcon_Darkorpse,
    [SPECIES_FUNNESUS] = gMonIcon_Funnesus,
    [SPECIES_PUPYRO] = gMonIcon_Pupyro,
    [SPECIES_PYRULPES] = gMonIcon_Pyrulpes,
    [SPECIES_KITSINICAL] = gMonIcon_Kitsinical,
    [SPECIES_COMMUNYMPH] = gMonIcon_Communymph,
    [SPECIES_MANTIFA] = gMonIcon_Mantifa,
    [SPECIES_HATCHAAL] = gMonIcon_Hatchaal,
    [SPECIES_CRUSYGLE] = gMonIcon_Crusygle,
    [SPECIES_BUBBABE] = gMonIcon_Bubbabe,
    [SPECIES_BUBBATH] = gMonIcon_Bubbath,
    [SPECIES_BUBBLUST] = gMonIcon_Bubblust,
    [SPECIES_CHANELING] = gMonIcon_Chaneling,
    [SPECIES_TROLLMODEL] = gMonIcon_Trollmodel,
    [SPECIES_SKORCHOP] = gMonIcon_Skorchop,
    [SPECIES_CUBEAST] = gMonIcon_Cubeast,
    [SPECIES_BEASTUNT] = gMonIcon_Beastunt,
    [SPECIES_HOOTUBE] = gMonIcon_Hootube,
    [SPECIES_CHANNOWL] = gMonIcon_Channowl,
    [SPECIES_BROYALTY] = gMonIcon_Broyalty,
    [SPECIES_FANDAM] = gMonIcon_Fandam,
    ...
    [SPECIES_MUSTELIT] = gMonIcon_Mustelit,
    [SPECIES_CAPENSEAR] = gMonIcon_Capensear,
    [SPECIES_MAPIG] = gMonIcon_Mapig,
    [SPECIES_PREDATOAR] = gMonIcon_Predatoar,
    [SPECIES_ILLUMARYD] = gMonIcon_Illumaryd,
    [SPECIES_ENLIMINATI] = gMonIcon_Enliminati,
    [SPECIES_ASTLEYROID] = gMonIcon_Astleyroid,
    [SPECIES_POSTLE] = gMonIcon_Postle,
    [SPECIES_HUSHBACK] = gMonIcon_Hushback,
    [SPECIES_SLICHIC] = gMonIcon_Slichic,
    [SPECIES_MURDEROO] = gMonIcon_Murderoo,
    [SPECIES_ROBBANK] = gMonIcon_Robbank,
    [SPECIES_CORRIMINAL] = gMonIcon_Corriminal,
    [SPECIES_VEGAVA] = gMonIcon_Vegava,
    [SPECIES_GLUTTOCADO] = gMonIcon_Gluttocado,
    [SPECIES_PLAYSTRIKE] = gMonIcon_Playstrike,
    [SPECIES_EXBULK] = gMonIcon_Exbulk,
    [SPECIES_TOUCHSPEED] = gMonIcon_Touchspeed,
    [SPECIES_ZOUNO] = gMonIcon_Zouno,
    [SPECIES_PHANESIS] = gMonIcon_Phanesis,
    [SPECIES_BIOSSIL] = gMonIcon_Biossil,
    [SPECIES_VIRANCIENT] = gMonIcon_Virancient,
    [SPECIES_EVECHO] = gMonIcon_Evecho,
    [SPECIES_BARSONIST] = gMonIcon_Barsonist,
    [SPECIES_CHIPCHUNE] = gMonIcon_Chipchune,
    [SPECIES_ORCLASSTRA] = gMonIcon_Orclasstra,
    [SPECIES_RELAQUA] = gMonIcon_Relaqua,
    [SPECIES_SQUEANIME] = gMonIcon_Squeanime,
    [SPECIES_ENIGMASH] = gMonIcon_Enigmash,
    [SPECIES_AIRPODON] = gMonIcon_Airpodon,
    [SPECIES_MIKOMODO] = gMonIcon_Mikomodo,
    [SPECIES_GOJIREC] = gMonIcon_Gojirec,
    [SPECIES_EEKORONE] = gMonIcon_Eekorone,
    [SPECIES_HALFIST] = gMonIcon_Halfist,
    [SPECIES_INEVITON] = gMonIcon_Ineviton,
    ...
    [SPECIES_DISPUTRAW_SPECIAL] = gMonIcon_DisputrawSpecial,
